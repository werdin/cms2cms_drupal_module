        ...
        if ( !$cms2cms_is_activated ) {
            ...
            <li id="cms2cms_accordeon_item_id_' .  $cms2cms_step_counter++ . '" class="cms2cms_accordeon_item cms2cms_accordeon_item_register">
                ...
                <form action="' .  $viewProvider->getRegisterUrl() . '"
                    ...
                    <div>
                        <input type="hidden" id="cms2cms-site-url" name="siteUrl" value="' .   $cms2cms_target_url . '"/>
                        <input type="hidden" id="cms2cms-bridge-url" name="targetBridgePath" value="' .   $cms2cms_bridge_url . '"/>
            ...
            <form action="' .   $viewProvider->getVerifyUrl() . '"
                ...
                <ol>
                    ...
                    <li>
                        ...
                        <a href="' .   $viewProvider->getVideoLink() . '" target="_blank">' .  $viewProvider->_e('Watch the video', 'cms2cms-migration'). '</a>
                    </li>
                    <li>
                        ' .   sprintf(
                        ...
                        . '"/>
                        <input type="hidden" name="sourceType" value="' .   $viewProvider->getPluginSourceType() . '" />
                        <input type="hidden" name="targetUrl" value="' .   $cms2cms_target_url. '" />
                        <input type="hidden" name="targetType" value="' .   $viewProvider->getPluginTargetType() . '" />
                        <input type="hidden" name="targetBridgePath" value="' .   $cms2cms_bridge_url. '" />
                    </li>
                </ol>
                <div class="error_message"></div>
                <button type="submit" class="button button-primary button-large">
